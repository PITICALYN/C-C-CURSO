...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top Bar - Conforme solicitado: Endereço e Links de Portais no Topo */}
      <div className="top-bar">
        <div className="container top-bar-content">
          <a href="https://maps.google.com/?q=Av.+Brasil,+Rio+de+Janeiro,+RJ,+Brasil" target="_blank" rel="noopener noreferrer" className="top-address">
            Av. Brasil, Rio de Janeiro, RJ, Brasil
          </a>
          <div className="top-portals">
            <Link to="/login" className="portal-link">Portal do Aluno</Link>
            <span className="separator">|</span>
            <Link to="/login" className="portal-link">Portal do Instrutor</Link>
          </div>
        </div>
      </div>
